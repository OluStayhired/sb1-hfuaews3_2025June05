...
interface ProPlanLimitModalProps {
  isOpen: boolean;
  onClose: () => void;
  // --- ADDED THIS LINE ---
    ...
    <div className=" bg-gradient-to-r from-blue-50 to-white border border-blue-100 rounded-lg hover:border-blue-300 transition-all group p-4 rounded-lg mb-6">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-center space-x-2">
              ...
              <span className="text-gray-900">Send Email to Sales and Upgrade</span>
            </li>
            <li className="flex items-center space-x-2">
              <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0" />
              <span className="text-gray-900">Simply Delete All Old Campaigns</span>
            </li>
            <li className="flex items-center space-x-2">
              <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0" />
              <span className="text-gray-900">Remove Old Unused Social Accounts</span>
            </li>
            <li className="flex items-center space-x-2">
              <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0" />
              <span className="text-gray-900">Contact Sales - team@sosavvy.so</span>
            </li>
          </ul>
        </div>
      ...
      */}
        ...
        {/* Upgrade Button */}
        <button
          onClick={handleCloseProPlanLimit}
